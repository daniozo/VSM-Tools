...
\begin{frame}
  ...
  % \node[anchor=south east] at (current page.south east){\includegraphics[height=1cm]{../../../images/logo_eigsi}};
...
\begin{frame}{Parcours Utilisateur Fluide}
  ...
  % \begin{figure} \includegraphics[width=0.5\textwidth]{../../../images/img_4} \end{figure}
\end{frame}
...
\begin{frame}{Pyramide d'Automatisation}
  \frametitle{Pyramide d'Automatisation}
  \begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{../../../images/automation_pyramide}
  \end{figure}
\end{frame}
...
% --- Section 6 : Management de Projet & Avancement ---
...
\begin{frame}{Sprints de l'Année 1}
  \frametitle{Sprints de l'Année 1}
  \begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{../../../images/sprints_premiere_annee}
  \end{figure}
\end{frame}
...
\begin{frame}{Planification et État d'Avancement}
  ...
  \begin{itemize}
    \item Phase conception (Sprints 1--5) \textbf{terminée}.
    \item Dossier de conception détaillé produit.
  \end{itemize}
\end{frame}


\begin{frame}{Dossier de Conception Obtenu}
  \frametitle{Dossier de Conception Obtenu}
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{../../../images/dossier_documentation}
  \end{figure}
\end{frame}
...
\begin{frame}{Conclusion}
  ...
  \begin{itemize}
    \item VSM : Outil clé, mais méthodes traditionnelles limitées.
    \item VSM-Tools : Solution dédiée, intuitive, \textbf{analytiquement puissante}.
    \item Phase de conception terminée, excellente base pour développement.
    \item Perspectives prometteuses : marché en croissance, besoin réel.
  \end{itemize}
  
  \vfill
  \textbf{Prochaines étapes :} \\
  Développement (Année 2) : MVP, tests utilisateurs.
\end{frame}
