...
\begin{itemize}
    ...
    \item \textbf{Un élève-ingénieur spécialisé en Intelligence Artificielle et Big Data (IABD) :} Responsable des aspects techniques du projet (conception de l'architecture logicielle, choix technologiques, conception des fonctionnalités avancées IA/prédictives, gestion des données, coordination technique).
\end{itemize}
