...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Initialisation du projet :} L'analyste commence par créer un nouveau projet, qui est une entrée dédiée dans la base de données PostgreSQL. Il peut également importer un fichier \texttt{.vsmx} existant pour initialiser un projet.
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/dialogue_ouvrir_projet.png}
              \caption{Dialogue d'ouverture et de création de projet.}
              \label{fig:ouvrir_projet}
          \end{figure}
    ...
    \item \textbf{Configuration du modèle de données :} L'étape centrale du travail se déroule dans le \textbf{Dialogue de Configuration Central}. L'analyste ne dessine pas, il modélise en remplissant des formulaires structurés pour :
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/dialconfig_vu_infos_general.png}
              \caption{Configuration : Informations générales du projet.}
              \label{fig:config_general}
          \end{figure}

          \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/dialconfig_vu_etapes_de_production.png}
              \caption{Configuration : Définition des étapes de production.}
              \label{fig:config_etapes}
          \end{figure}

          \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/dialconfig_vu_indicteurs.png}
              \caption{Configuration : Gestion des indicateurs.}
              \label{fig:config_indicateurs}
          \end{figure}
    ...
    \item \textbf{Visualisation et analyse de l'état actuel :} Une fois la configuration appliquée, l'algorithme de layout génère automatiquement le diagramme VSM sur le canevas. L'analyste peut alors :
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=1\textwidth]{../../../images/imgfinals/vu_diagramme_etat_actuel_avec_panneaux_explorateur_et_propriete.png}
              \caption{Vue du diagramme État Actuel avec les panneaux latéraux.}
          ...
          \begin{figure}[H]
              ...
              \caption{Panneau d'analyse mettant en évidence les problèmes détectés.}
              \label{fig:analyse_problemes}
          \end{figure}

          \begin{figure}[H]
              \centering
              \includegraphics[width=0.4\textwidth]{../../../images/imgfinals/vu_avec_panneau_assistant.png}
              \caption{L'assistant conversationnel intégré.}
              \label{fig:assistant}
          \end{figure}
    ...
    \item \textbf{Enrichissement et plan d'action :} L'analyse débouche sur des actions concrètes. L'analyste peut :
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/vu_avec_panneau_plan_daction_montrant_une_action_a_realiser.png}
              \caption{Gestion du plan d'action.}
              \label{fig:plan_action}
          \end{figure}

          \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/vu_note_prise.png}
              \caption{Prise de notes contextuelle.}
              \label{fig:notes}
          \end{figure}
\end{enumerate}
...
\begin{description}[leftmargin=*, style=unboxed]
    ...
    \item[Fonctionnalités Incluses :]
          ...
          \end{itemize}
    \item[Modèle de Prix Suggéré :] Abonnement mensuel ou annuel par utilisateur (ex: prix fixe/utilisateur/mois).
\end{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../../../images/imgfinals/business_model_canvas.png}
...
\begin{figure}[H]
    ...
    \caption{Diagramme de Gantt de la phase d'implémentation.}
    \label{fig:gantt_implementation}
\end{figure}
...
\subsection{Annexe A : Autres vues de l'application}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../../images/imgfinals/vu_diagramme_etat_actuel_sans_panneaux_lateraux.png}
    \caption{Vue épurée du diagramme État Actuel.}
    \label{fig:vue_epuree}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../../../images/imgfinals/dialconfig_vu_analyse_et_prediction.png}
    \caption{Configuration de l'analyse et de la prédiction.}
    \label{fig:config_analyse}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../../../images/imgfinals/dial_ajout_de_note.png}
    \caption{Dialogue d'ajout de note.}
    \label{fig:ajout_note}
\end{figure}

\subsection{Annexe B : Dépôt GitHub du Projet}
